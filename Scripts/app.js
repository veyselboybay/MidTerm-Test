...
"use strict";
    ...
    function Paragraphs()
    {
        //intro paragraph injected
        let intro=document.getElementById("IntroParagraph");
        intro.textContent="Now is the time to travel to Greece. The country may be going through an economic crisis, but many travellers say that it hasn't impacted the experience of visiting. Plus, there may be some great deals."+ 
